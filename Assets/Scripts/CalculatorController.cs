...
//// UI создаётся полностью кодом
//public class CalculatorController : MonoBehaviour
//{
//    public static CalculatorController Instance { get; private set; }
...
//    // Создаёт объект, если его ещё нет
//    public static CalculatorController GetOrCreate()
//    {
//        if (Instance != null)
//            return Instance;

//        var go = new GameObject("CalculatorController");
//        go.AddComponent<CalculatorController>();
//        return Instance;
//    }
...
//    {
//        // Корневой Canvas поверх всего
//        canvasGo = new GameObject("CalculatorCanvas");
...
//        panelRt.sizeDelta = new Vector2(620, 860);

//        // Вертикальная компоновка внутри панели
...
//        {
//            Color color = new Color(0.22f, 0.26f, 0.33f); // обычные кнопки
...
//        closeLe.preferredHeight = 90;
//        var closeBtn = closeGo.AddComponent<Button>();
//        var closeImg = closeGo.AddComponent<Image>();
//        closeImg.color = new Color(0.55f, 0.20f, 0.20f);
//        var closeText = CreateTextChild(closeGo.transform, "Закрыть", 44);
...
//    {
//        // Ищем последний оператор (простая схема: один пример a op b)
//        char op = '\0';
//        int opIndex = -1;
